export const skillsData = [
  ...
  },
  {
    ...
    description: "Modern web development with React.js, JavaScript, and responsive design. Proficient in HTML5, CSS3, Tailwind CSS, and creating seamless user experiences across all devices.",
    icon: "",
